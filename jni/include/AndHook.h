...
# define AK_BOOL int
    ...
    /// <summary>
    /// Sets protection on the specified region of memory and addr is NOT necessary to be aligned to a page boundary
    /// </summary>
    AK_BOOL AKProtectMemory(const void *addr, const uintptr_t len, int prot/* = AK_RWX*/);
    /// <summary>
